...
export default function Preview() {
  ...
  return (
    <div className={`flex flex-col h-full bg-background ${isFullscreen ? 'fixed inset-0 z-50 bg-background' : ''} transition-colors duration-300`}>
      {/* 预览头部 */}
      <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-black/5 dark:bg-white/5 backdrop-blur-sm select-none">
        ...
        <div className="flex items-center gap-2">
           <div className="flex items-center bg-surface rounded-md border border-black/10 dark:border-white/10 overflow-hidden">
      ...
      {/* 预览内容区 */}
      <div className="flex-1 overflow-auto p-8 bg-black/5 dark:bg-white/5 relative scrollbar-thin">
        {/* 背景网格装饰 */}
        ...
        >
          <div className="word-preview p-[2.54cm]"> {/* 标准 Word 页边距 */}
            {previewContent ? (
              ...
              <div className="flex flex-col items-center justify-center h-[600px] text-text-dim select-none">
